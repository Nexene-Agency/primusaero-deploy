...
import TeamMembersList from "@components/dashboard/team/list";

const TeamMembersManager = (props: any) => {
    ...
    <ContextProviders>
      <VStack align="left" width="100%">
        <Text fontSize="xl" fontWeight="bold">
          {t("app.teamMember.plural")}
        </Text>
        {data ? <TeamMembersList onAction={listAction} /> : loading(t)}
      </VStack>
    </ContextProviders>
  ) : null;
};
