    ...
    <>
      {props.withoutMap ? null : (
        <div className="flex flex-col __restricted-width items-center">
          <div
            className="w-full px-6 lg:px-0 mb-8 lg:mb-0 lg:text-center text-stone-950 mt-36 lg:mt-0 text-5xl lg:text-8xl font-bold font-muller uppercase leading-10">
